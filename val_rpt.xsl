...
use="generate-id(preceding-sibling::svrl:fired-rule[1])"/>
	...
	<html>
		<head>
					<link rel="stylesheet" type="text/css" href="https://svn.gene.le.ac.uk/gen2phen/trunk/data_formats/xml/val_rpt.css" />
					<style type="text/css" media="screen">@import "https://svn.gene.le.ac.uk/gen2phen/trunk/data_formats/xml/val_rpt.css";</style>					
